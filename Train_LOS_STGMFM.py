...
from utils.Dataload_LOS import create_dataset_for_cross_validation
...
if __name__ == "__main__":
    ...
    parser.add_argument("-device", type=int, default=4)  # ---###运行时修改###--- #
